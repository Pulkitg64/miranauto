    ...
    <footer className="mt-20 border-t py-10 border-neutral-700">
        <section>
            <div class="container px-6 py-12 mx-auto">
                <div>
                    <p class="font-medium text-orange-400 dark:text-orange-800">Contact us</p>
                    <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Get in touch</h1>
                </div>
                
                <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                <div>
                    <span class="inline-block p-3 text-orange-400 rounded-full bg-orange-100/80 dark:bg-gray-800">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-500 dark:text-gray-400">(+91) 9888770064</p>
            </div>
        </div>
    </div>
</section>
